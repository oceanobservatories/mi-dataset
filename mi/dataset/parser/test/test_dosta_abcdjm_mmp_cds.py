...
RESOURCE_PATH = os.path.join(Config().base_dir(), 'mi', 'dataset', 'driver', 'dosta_abcdjm', 'mmp_cds', 'resource')
...
class DostaAbcdjmMmpCdsParserUnitTestCase(ParserUnitTestCase):
    ...
    def test_bad_data_one(self):
        ...
        file_path = os.path.join(RESOURCE_PATH, 'optode_1_20131124T005004_BAD.mpk')
        stream_handle = open(file_path, 'rb')
