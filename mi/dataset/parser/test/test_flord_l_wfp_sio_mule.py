...
"""
@package mi.dataset.parser.test.test_flord_l_wfp_sio_mule
@file marine-integrations/mi/dataset/parser/test/test_flord_l_wfp_sio_mule.py
@author Maria Lutz
...
class FlordLWfpSioMuleParserUnitTestCase(ParserUnitTestCase):
    ...
    def test_get_many(self):
        ...
        self.assertEqual(result,[self.particle_1a, self.particle_1b, self.particle_1c, self.particle_2a])
